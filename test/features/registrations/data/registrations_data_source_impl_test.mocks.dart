...
// in elections/test/features/registrations/data/registrations_data_source_impl_test.dart.
...
/// A class which mocks [BaseFirebaseStorage].
///
/// See the documentation for Mockito's code generation for more information.
class MockBaseFirebaseStorage extends _i1.Mock
    implements _i6.BaseFirebaseStorage {
  MockBaseFirebaseStorage() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<String> uploadFile(
          _i7.UploadImageToStorageParams? uploadImageToStorageParams) =>
      (super.noSuchMethod(
        Invocation.method(
          #uploadFile,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBaseAuthService extends _i1.Mock implements _i8.BaseAuthService {
  MockBaseAuthService() {
    _i1.throwOnMissingStub(this);
  }
